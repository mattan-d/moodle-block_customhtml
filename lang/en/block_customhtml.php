...
$string['configcohort'] = 'Show only to cohort';
$string['configcohort_help'] = 'If a cohort is selected, only users who belong to that system cohort will see this block and its content. If "Show to everyone" is selected, the block is visible to all.';
$string['configcohortnone'] = 'Show to everyone';
